...
**321 tests passing.** Full development history (45 chronological
...
- **DualHead beats every other controller**, consistently across seeds:
  **48.68% mean yield** vs. Blind's 40.03% and single-head Predictive's
  40.69% — and with the *lowest* variance of any real controller tested.
